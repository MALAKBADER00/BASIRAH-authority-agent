...
class FeedbackAgent:
    ...
    def generate_ai_feedback(self):
        prompt = f"""
        You are a **Vhishing training coach** speaking directly to a trainee about their performance.
        ...
        **INSTEAD,** speak to them directly (e.g., "You did...", "Your use of authority...").

        Your job is to evaluate how well the trainee performed a social engineering attack based on the conversation log.

        Focus heavily on:
        - How well **you** applied the psychological principle **AUTHORITY**.
    ...
    def generate_ai_voice_feedback(self):
        ...
        prompt = f"""
            ...
            Provide a conversational, informal voice-style feedback about their vishing attempt using the **Authority** principle.

            Style: Short, informal, constructive. Like a mentor speaking.
            ...
            Highlight their use of authority/status, specific mistakes, and one good action.
